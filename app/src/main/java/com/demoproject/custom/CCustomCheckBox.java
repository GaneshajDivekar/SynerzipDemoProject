package com.demoproject.custom;
...
public class CCustomCheckBox extends AppCompatCheckBox {
    public CCustomCheckBox(Context context) {
        super(context);
        init(null);
    }

    public CCustomCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public CCustomCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
